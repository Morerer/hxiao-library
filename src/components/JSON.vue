  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        ...
        <li v-for="famousWork in allFamousWorks" :key="famousWork.title">
          Title: {{ famousWork.title }}, Year: {{ famousWork.year }}
        </li>
      </ul>
      ...
      <ul>
        <li v-for="famousWork in austen.allFamousWorks" :key="famousWork.title">
          Title: {{ famousWork.title }}, Year: {{ famousWork.year }}
        </li>
      </ul>
    </section>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(hours, kindOfDay) in bookstores.openingHours" :key="kindOfDay">
          {{ kindOfDay }} open from: {{ hours.open }}, closed in : {{ hours.close }}
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <div :style="{ color: textColor, fontSize: fontSize + 'px' }">George Orwell</div>
    </section>
  </div>
</template>
